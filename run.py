...
from model.D3MG_3DP import Trainer
...
# New args for D3MG_3DP
parser.add_argument('--grid_h', default=int(clean_config_value(config['model'].get('grid_h', '8'))), type=int)
parser.add_argument('--grid_w', default=int(clean_config_value(config['model'].get('grid_w', '8'))), type=int)
...
elif args.model == 'D3MG_3DP':
    from model.D3MG_3DP import D3MG_3DP as Network
else:
...
if args.mode == 'train':
    ...
    # Put your model abosolute path here for test
